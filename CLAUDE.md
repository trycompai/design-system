...
turbo run build --filter=@trycompai/design-system
turbo run dev --filter=@comp/storybook
```
...
- `organisms/` - Complex sections (Sidebar, NavigationMenu, etc.)
- `ui/index.ts` - Re-exports all components
