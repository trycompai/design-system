...
export default function SettingsGeneralPage() {
  return (
    <PageLayout>
      ...
      <Stack gap="6">
        <Section title="Organization Name" description="This is your organization's display name.">
          <Stack gap="3">
        ...
        <Section title="Support Email" description="Where should we send important notifications?">
          <Stack gap="3">
            <Stack gap="2">
