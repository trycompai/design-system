...
describe('Heading', () => {
  ...
  it('allows overriding element with as prop', () => {
    render(
      <Heading level="1" as="h3" data-testid="heading">
        Override
      </Heading>,
    );
    expect(screen.getByTestId('heading').tagName).toBe('H3');
  ...
  describe('variants', () => {
    ...
    it('applies muted variant', () => {
      render(
        <Heading variant="muted" data-testid="heading">
          Muted
        </Heading>,
      );
  ...
  it('applies tracking variant', () => {
    render(
      <Heading tracking="tight" data-testid="heading">
        Tight
      </Heading>,
    );
...
describe('Text', () => {
  ...
  describe('color variants', () => {
    ...
    it('applies primary variant', () => {
      render(
        <Text variant="primary" data-testid="text">
          Primary
        </Text>,
      );
    ...
    it('applies destructive variant', () => {
      render(
        <Text variant="destructive" data-testid="text">
          Error
        </Text>,
      );
  ...
  it('applies font variant', () => {
    render(
      <Text font="mono" data-testid="text">
        Monospace
      </Text>,
    );
  ...
  it('applies leading variant', () => {
    render(
      <Text leading="relaxed" data-testid="text">
        Relaxed
      </Text>,
    );
